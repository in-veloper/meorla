    ...
    return (
        <Card className="p-3 w-100">
            ...
            <Row className="d-flex no-gutters">
                이 약관은 이해컴퍼니 (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
            </Row>
            <Row className="d-flex no-gutters font-weight-bold mt-3">
                제2조(정의)
            </Row>
            ...
            <Row className="d-flex no-gutters ml-5">
                가. 폰뱅킹, 인터넷뱅킹, 온라인 무통장입금 등의 각종 계좌이체
            </Row>
            <Row className="d-flex no-gutters ml-3">
